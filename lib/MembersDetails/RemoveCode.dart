...
class RemoveCode extends StatefulWidget {
  const RemoveCode({Key? key, required this.familyId}) : super(key: key);
  final String familyId;


  @override
  State<RemoveCode> createState() => _RemoveCodeState();
}

class _RemoveCodeState extends State<RemoveCode> {
